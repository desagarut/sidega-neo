								...
								<form id="validasi" action="<?= $form_action ?>" method="POST" target="_blank" class="form-horizontal">
									<div class="col-md-12">
										...
										<div class="form-group row subtitle_head">
											...
											<div class="btn-group col-sm-9" data-toggle="buttons">
												<label id="pemohon_11" class="btn btn-info btn-sm col-sm-2 mr-2 form-check-label <?php if (!empty($individu)) : ?>active<?php endif ?>">
												...
												<label id="pemohon_22" class="btn btn-info btn-sm col-sm-2 mr-2 form-check-label <?php if (empty($individu)) : ?>active<?php endif; ?>">
										...
										<div class="form-group row pemohon_desa" <?php if (empty($individu)) : ?>style="display: none;" <?php endif; ?>>
										...
										<?php if (empty($individu)) : ?>
											<div class="form-group row pemohon_luar_desa">
									...
									<div class="col-md-12">
										<div class="form-group row subtitle_head">
											...
											<div class="btn-group col-sm-9" data-toggle="buttons">
												<label class="btn btn-info btn-flat btn-sm col-sm-2 mr-2 form-check-label <?php if (!empty($saksi1)) : ?>active<?php endif ?>">
												...
												<label id="label_saksi1_2" class="btn btn-info btn-flat mr-2 btn-sm col-sm-2 form-check-label <?php if (empty($saksi1)) : ?>active<?php endif; ?>">
										...
										<div class="form-group row saksi1_desa" <?php if (empty($saksi1)) : ?>style="display: none;" <?php endif; ?>>
									...
									<div class="col-md-12">
										<div class="form-group row subtitle_head">
											...
											<div class="btn-group col-sm-9" data-toggle="buttons">
												<label class="btn btn-info btn-flat btn-sm col-sm-2 mr-2 form-check-label <?php if (!empty($saksi2)) : ?>active<?php endif ?>">
												...
												<label id="label_saksi2_2" class="btn btn-info btn-flat mr-2 btn-sm col-sm-2 form-check-label <?php if (empty($saksi2)) : ?>active<?php endif; ?>">
										...
										<div class="form-group row saksi2_desa" <?php if (empty($saksi2)) : ?>style="display: none;" <?php endif; ?>>
