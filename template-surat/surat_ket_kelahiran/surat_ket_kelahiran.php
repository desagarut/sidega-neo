							...
							<div class="card-body">
								<form id="validasi" action="<?= $form_action ?>" method="POST" target="_blank" class="form-surat form-horizontal">
									...
									<div class="col-md-12">
										...
										<div class="form-group row ibu_desa" <?php if (empty($ibu)) : ?>style="display: none;" <?php endif; ?>>
										...
										<?php endif; ?>
										<?php if (empty($bayi)) : ?>
											<div class="form-group row bayi_luar_desa">
										...
										<div class="form-group row pelapor_desa" <?php if (empty($pelapor)) : ?>style="display: none;" <?php endif; ?>>
