							...
							<div class="card-body">
								<form id="validasi" action="<?= $form_action ?>" method="POST" target="_blank" class="form-surat form-horizontal">
									...
									<div class="col-md-12">
										...
										<!-- pemberi kuasa -->
										<div class="form-group row subtitle_head" id="a_pemberi_kuasa">
											<label class="col-sm-3 control-label" for="status">PEMBERI KUASA</label>
										</div>
										<div class="form-group row pemberi_kuasa_desa">
										...
										<!-- penerima kuasa -->
										<div class="form-group row subtitle_head" id="a_penerima_kuasa">
										...
										<div class="form-group row penerima_kuasa_desa" <?php if (empty($penerima_kuasa)) : ?>style="display: none;" <?php endif; ?>>
										...
										<?php if (empty($penerima_kuasa)) : ?>
											<div class="form-group row penerima_kuasa_luar_desa">
