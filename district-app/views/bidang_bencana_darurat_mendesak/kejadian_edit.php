	...
	<section class="content" id="maincontent">
		<div class="card shadow">
			<div class="card-header">
				<a href="<?=site_url('bidang_bencana_darurat_mendesak')?>" class="btn btn-info btn-sm " title="Kembali Ke Daftar Laporan Kejadian"><i class="fe fe-arrow-circle-o-left"></i> Kembali Ke Daftar Laporan Kejadian</a>
			</div>
