				...
				<div class="card shadow">
					<div class="box-body">
						<div class="card-header">
							<a href="<?= site_url('data_sppt/clear')?>" class="btn btn-primary btn-sm " title="Kembali Ke Daftar Objek Pajak"><i class="fe fe-arrow-circle-o-left"></i> Kembali Ke Daftar Objek Pajak</a>
						</div>
						<div class="row">
							<div class="col-sm-12">
								...
								<form name='mainform' action="<?= site_url('data_sppt/simpan_sppt')?>" method="POST"  id="validasi" class="form-horizontal">
									...
									<div class="box-footer">
										<div class="col-xs-12">
											...
											<button type="submit" class="btn btn-info btn-sm pull-right"data-target="#confirm-delete"><i class="fe fe-check"></i> Simpan</button>
										</div>
									</div>
								</form>
							</div>
