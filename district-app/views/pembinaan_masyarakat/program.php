			...
			<li class="active">Daftar Program Pembinaan Kemasyarakatan</li>
				...
				<div class="card shadow">
					<div class="card-header">
                        ...
                        <a href="<?=site_url('pembinaan_masyarakat/create')?>" class="btn btn-social btn-box bg-olive btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Program Bantuan"><i class="fe fe-plus"></i> Tambah</a>
						...
						<?php endif;?>
                        <a href="<?=site_url('pembinaan_masyarakat/panduan')?>" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Panduan"><i class="fe fe-question-circle"></i> Panduan</a>
						<?php if ($tampil != 0): ?>
							<a href="<?=site_url('pembinaan_masyarakat')?>" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Program Bantuan"><i class="fe fe-arrow-circle-o-left"></i> Kembali Ke Daftar Program Bantuan</a>
						<?php endif; ?>
					</div>
					<div class="card-body">
						<div class="row">
													...
													<tbody>
														...
														<?php foreach ($program as $item): ?>
															...
															<tr>
																...
																<?php if ($this->CI->cek_hak_akses('h')): ?>
                                                                <td nowrap>
																	<a href="<?= site_url("pembinaan_masyarakat/detail/$item[id]")?>" class="btn bg-purple btn-box btn-sm" title="Rincian"><i class="fe fe-list"></i></a>
