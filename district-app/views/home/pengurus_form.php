			...
			<div class="col-sm-12">
				<div class="card card-info">
					<div class="card-header with-border">
						<a href="<?= site_url()?>pengurus" class="btn btn-social btn-card btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Staf</a>
					</div>
					<div class="card-body">
						<div class="form-group col-sm-12 form-horizontal">
							...
							<div class="btn-group col-sm-8 kiri" data-toggle="buttons">
								<label for="pengurus_1" class="btn btn-info btn-card btn-sm col-sm-3 form-check-label <?php if (empty($pamong) or !empty($individu)): ?>active<?php endif ?>">
								...
								<label for="pengurus_2" class="btn btn-info btn-card btn-sm col-sm-3 form-check-label <?php if (!empty($pamong) and empty($individu)): ?>active<?php endif; ?>">
				...
				<div class="col-md-9">
					<div class="card card-primary">
						...
						<div class='card-footer'>
							<div class='col-xs-12'>
								<button type='reset' class='btn btn-social btn-card btn-danger btn-sm'  onclick="reset_form($(this).val());"><i class='fa fa-times'></i> Batal</button>
								<button type='submit' class='btn btn-social btn-card btn-info btn-sm pull-right confirm'><i class='fa fa-check'></i> Simpan</button>
							</div>
						</div>
					</div>
				</div>
