		...
		<form id="mainform" name="mainform" action="" method="post">
          ...
          <?php $this->load->view('plan/nav.php')?>
            ...
            <div class="card-header">
							<a href="<?=site_url("point/ajax_add_sub_point/$point[id]")?>" class="btn btn-success btn-sm btn-sm "  title="Tambah Kategori <?= $point['nama']; ?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tambah Kategori <?= $point['nama']; ?>">
								<i class="fe fe-plus"></i>Tambah Kategori <?= $point['nama']; ?>
            	</a>
							<?php if ($this->CI->cek_hak_akses('h')): ?>
								<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("point/delete_all/")?>')" class="btn btn-danger btn-sm  hapus-terpilih"><i class='fe fe-trash-o'></i> Hapus Data Terpilih</a>
							<?php endif; ?>
