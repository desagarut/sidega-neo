      ...
      <div class="col-12">
        <div class="row align-items-center mb-2">
          ...
          <form id="mainform" name="mainform" action="" method="post">
            <div class="row">
              <div class="col-md-3">
                <div id="bantuan" class="card shadow">
                                ...
                                <?php foreach ($main as $key => $data) : ?>
                                  <tr>
                                    ...
                                    <td class="aksi">
                                      ...
                                      <?php if ($this->CI->cek_hak_akses('h')) : ?>
                                        <a href="<?= site_url("kelompok/form/$p/$o/$data[id]"); ?>" class="btn btn-outline-info btn-sm" title="Ubah Data Kelompok"><i class='fe fe-edit'></i></a>
