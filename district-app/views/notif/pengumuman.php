		...
		<div class='modal-dialog'>
			<div class='modal-content'>
				...
				<div class='modal-footer' id='m_footer'>
					<?php if ($jenis == 'pengumuman'): ?>
						<button type="reset" data-dismiss="modal" id="btnSetuju" class="btn btn-social btn-box btn-warning btn-sm"><i class='fe fe-sign-out'></i> OK</button>
					<?php else: ?>
						<button type="reset" data-dismiss="modal" id="btnTidak" class="btn btn-social btn-box btn-danger btn-sm"><i class='fe fe-sign-out'></i> Tidak</button>
						<button  type="submit" id="btnSetuju" class="btn btn-social btn-box btn-warning btn-sm"><i class='fe fe-check'></i> Setuju</button>
					<?php endif; ?>
				</div>
			</div>
		</div>
