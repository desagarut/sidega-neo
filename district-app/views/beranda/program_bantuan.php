        ...
        <div class='card-body'>
            <div class="col-md-12">
              ...
              <div class="progress-group">
                <a href="<?=site_url('program_bantuan')?>" class="small-card-footer" title="Lihat Program Bantuan">
              ...
              <div class="progress-group">
                <a href="<?=site_url('kelompok/clear')?>" class="small-card-footer" title="Lihat Daftar Kelompok Masyarakat">
                <span class="progress-number">
