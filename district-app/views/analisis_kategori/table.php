	...
	<section class="content" id="maincontent">
		...
		<form id="mainform" name="mainform" action="" method="post">
            ...
            <div class="box-header with-border">
							...
							<a href="<?= site_url()?>analisis_kategori/leave" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fe fe-arrow-circle-left "></i> Kembali Ke <?= $analisis_master['nama']?></a>
												...
												<div class="col-sm-12">
													...
													<div class="input-group input-group-sm pull-right">
														...
														<div class="input-group-btn">
															...
															<button type="submit" class="btn btn-default" onclick="$('#'+'mainform').attr('action', '<?= site_url("analisis_kategori/search")?>');$('#'+'mainform').submit();"><i class="fe fe-search"></i></button>
															...
															<thead class="bg-gray disabled color-palette">
																...
																<tr>
																	...
																	<?php if ($o==4): ?>
																		...
																		<th><a href="<?= site_url("analisis_kategori/index/$p/3")?>">Kategori/Variabel <i class='fe fe-sort-asc fa-sm'></i></a></th>

																	<?php elseif ($o==3): ?>

																		<th><a href="<?= site_url("analisis_kategori/index/$p/4")?>">Kategori/Variabel <i class='fe fe-sort-desc fa-sm'></i></a></th>

																	<?php else: ?>

																		<th><a href="<?= site_url("analisis_kategori/index/$p/4")?>">Kategori/Variabel <i class='fe fe-sort fa-sm'></i></a></th>
