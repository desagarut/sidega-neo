		...
		<form id="mainform" name="mainform" action="" method="post">
			<div class="card shadow">
				<div class="card-header">
					<a href="<?=site_url('data_dtks/form')?>" class="btn btn-outline-info btn-sm" title="Tambah data_dtks Baru"><i class="fe fe-plus"></i> Tambah Kategori Data</a>
									...
									<?php if ($data_dtks): ?>
										<?php	foreach ($data_dtks as $key => $item):	?>
											<tr>
												...
												<td class="aksi">
													<a href="<?= site_url("data_dtks/clear/$item[id]"); ?>" class="btn btn-outline-info btn-sm" title="Rincian Data"><i class="fe fe-list"></i></a>
													<a href="<?= site_url("data_dtks/form/$item[id]"); ?>" class="btn btn-outline-info btn-sm" title="Ubah Data"><i class='fe fe-edit'></i></a>
													<a
														<?php if ($item['jml'] <= 0): ?>
