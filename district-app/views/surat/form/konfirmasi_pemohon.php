<div class="col-md-12">
	...
	<div class="form-group row konfirmasi tdk-permohonan tdk-periksa">
		...
		<div class="col-sm-8">
			<a href="<?= site_url("penduduk/dokumen_list/{$individu['id']}") ?>" class="btn btn-outline-info btn-sm" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Daftar Dokumen">
				<i class='fe fe-book'></i> Daftar Dokumen
			</a>
			<a href="<?= site_url("penduduk/dokumen/{$individu['id']}") ?>" class="btn btn-social btn-flat btn-primary btn-sm" target="_blank">
