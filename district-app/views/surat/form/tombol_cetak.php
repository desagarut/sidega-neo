<div class="card-footer text-center">
	<?php if ($mandiri): ?>
		<button type="reset" onclick="window.history.back();" class="btn btn-danger"><i class="fe fe-x"></i> Batal</button>
	<?php elseif ($periksa): ?>
		<a href="<?= site_url("permohonan_surat_admin/konfirmasi/{$periksa['id']}"); ?>" class="btn btn-danger" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Konfirmasi Belum Lengkap"><i class="fe fe-times"></i> Belum Lengkap</a>
	<?php else: ?>
		<button type="reset" onclick="$('#validasi').trigger('reset');" class="btn btn-danger "><i class="fe fe-x"></i> Batal</button>
	<?php endif; ?>
	<?php if ($mandiri): ?>
