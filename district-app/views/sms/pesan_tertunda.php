		...
		<form id="mainform" name="mainform" action="" method="post">
			<div class="row">
					...
					<div class="card card-shadow">
						...
						<div class="box-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								...
								<li class="active"><a href="<?= site_url('sms/pending')?>"><i class="fe fe-file-text-o"></i> Pesan Tertunda</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-9">
					<div class="card card-shadow">
            <div class="box-header with-border">
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("sms/delete_all/$p/$o/3")?>')" class="btn btn-social btn-box btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block hapus-terpilih"><i class='fe fe-trash-o'></i> Hapus Data Terpilih</a>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-sm-12">
                                  ...
                                  <th>Nama</th>
																	<?php if ($o==2): ?>
                                    <th><a href="<?= site_url("sms/pending/$p/1")?>">Nomor HP <i class='fe fe-sort-asc fa-sm'></i></a></th>
                                  <?php elseif ($o==1): ?>
                                    <th><a href="<?= site_url("sms/pending/$p/2")?>">Nomor HP <i class='fe fe-sort-desc fa-sm'></i></a></th>
                                  <?php else: ?>
                                    <th><a href="<?= site_url("sms/pending/$p/1")?>">Nomor HP <i class='fe fe-sort fa-sm'></i></a></th>
                                  <?php endif; ?>
																	<th>Isi Pesan</th>
                                  <?php if ($o==6): ?>
                                    <th nowrap><a href="<?= site_url("sms/pending/$p/5")?>">Dikirim <i class='fe fe-sort-asc fa-sm'></i></a></th>
                                  <?php elseif ($o==5): ?>
                                    <th nowrap><a href="<?= site_url("sms/pending/$p/6")?>">Dikirim <i class='fe fe-sort-desc fa-sm'></i></a></th>
                                  <?php else: ?>
                                    <th nowrap><a href="<?= site_url("sms/pending/$p/5")?>">Dikirim <i class='fe fe-sort fa-sm'></i></a></th>
                                  <?php endif; ?>
																</tr>
															</thead>
															<tbody>
