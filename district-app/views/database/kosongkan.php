																				...
																				<td style="padding-top:20px;padding-bottom:10px;">
																					<div class="form-group">
																						...
																						<div class="col-sm-12 col-md-3 col-lg-2">
																							<a href="#" form="kosongkan" class="btn btn-block btn-danger btn-sm"  title="Kosongkan DB" data-toggle="modal" data-target="#confirmsubmit"><i class="fe fe-trash-o"></i> Kosongkan DB</a>
																						</div>
													...
													<div class='modal-dialog'>
														<div class='modal-content'>
															...
															<div class='modal-footer'>
																<button type='button' class='btn btn-warning btn-sm' data-dismiss='modal'><i class='fe fe-sign-out'></i> Tutup</button> <a href="#" id="submit" class='btn btn-danger btn-sm'><i class='fe fe-times'></i> Hapus</a>
															</div>
														</div>
													</div>
												</div>
