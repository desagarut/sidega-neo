<main role="main" class="main-content">
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url('gallery') ?>"><i class="fe fe-dashboard"></i> Playlist</a></li>
				...
				<div class="col-md-12">
					<div class="card card-shadow">
						<div class="box-header with-border">
							<a href="<?= site_url("gallery_youtube") ?>" class="btn btn-sm btn-outline-info mb-1"title="Tambah Artikel">
								<i class="fe fe-arrow-circle-left "></i>Back to Playlist
							</a>
						</div>
						<div class="box-body">
