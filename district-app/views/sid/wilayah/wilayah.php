				...
				<div class="card shadow">
					<div class="card-body">
						<?php if ($this->CI->cek_hak_akses('h')) : ?>
							<a href="<?= site_url("sid_core/form") ?>" class="btn btn-sm mb-2 btn-success" title="Tambah"><i class="fe fe-plus fe-16 mr-2 text-light"></i> Tambah</a>
						<?php endif; ?>
						<a href="<?= site_url("sid_core/dialog/cetak") ?>" class="btn mb-2 btn-primary" data-toggle="modal" data-target="#modalBox"><i class="fe fe-printer fe-16 mr-2 text-light"></i> Cetak</a>
						<a href="<?= site_url("sid_core/dialog/unduh") ?>" title="Unduh Data" class="btn btn-sm mb-2 btn-secondary" title="Unduh Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Data"><i class="fe fe-download fe-16 mr-2 text-light"></i> Unduh</a>
