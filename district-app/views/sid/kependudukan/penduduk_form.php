		...
		<div class="row justify-content-center">
			<div class="col-12">
				<div class="row align-items-center">
					...
					<div class="col-auto">
						<a href="<?= site_url("penduduk/clear"); ?>" class="btn btn-outline-info btn-sm mb-2" title="Kembali Ke Daftar Penduduk"><i class="fe fe-arrow-circle-o-left"></i> Kembali Ke Daftar Penduduk</a>
					</div>
				</div>
