		...
		<div class="card shadow">
			<div class="card-header">
				<?php if ($this->CI->cek_hak_akses('h')): ?>
					...
					<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform','<?= site_url("rtm/delete_all"); ?>')" class="btn btn-social btn-box	btn-danger btn-sm  hapus-terpilih"><i class='fe fe-trash'></i> Hapus Data Terpilih</a>
				<?php endif; ?>
				<a href="<?= site_url("rtm/ajax_cetak/$o/cetak"); ?>" class="btn btn-outline-info btn-sm " title="Cetak Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Data" target="_blank"><i class="fe fe-printer"></i> Cetak</a>
				<a href="<?= site_url("rtm/ajax_cetak/$o/unduh"); ?>" class="btn btn-outline-info btn-sm" title="Unduh Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Data" target="_blank"><i class="fe fe-download"></i> Unduh</a>
									...
									<?php if($main): ?>
										<?php foreach ($main as $key => $data): ?>
											<tr>
												...
												<td class="aksi">
													<a href="<?= site_url("rtm/anggota/$data[id]"); ?>" class="btn btn-outline-info btn-sm" title="Rincian Anggota Rumah Tangga"><i class="fe fe-list"></i></a>
													<?php if ($this->CI->cek_hak_akses('h')): ?>
													...
													<a href="<?= site_url("rtm/edit_nokk/$data[id]"); ?>" title="Ubah Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Rumah Tangga" class="btn btn-outline-info btn-sm"><i class='fe fe-edit'></i></a>
                                                    <a href="#" data-href="<?= site_url("rtm/delete/$data[no_kk]"); ?>" class="btn btn-outline-info btn-sm" title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash"></i></a>
													<?php endif; ?>
												</td>
												<td class="padat">
