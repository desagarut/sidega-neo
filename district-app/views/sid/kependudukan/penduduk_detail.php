      ...
      <div class="col-12">
        <div class="row align-items-center">
          ...
          <div class="col-auto">
            <?php if ($this->CI->cek_hak_akses('h')) : ?>
              <a href="<?= site_url("penduduk/dokumen/$penduduk[id]") ?>" class="btn btn-info mb-2 text-light" title="Manajemen Dokumen Penduduk"><i class="fe fe-file"></i> Manajemen Dokumen</a>
              ...
              <?php endif; ?>
            <?php endif; ?>
            <a href="<?= site_url("penduduk/cetak_biodata/$penduduk[id]") ?>" class="btn btn-outline-info mb-2" title="Cetak Biodata" target="_blank"><i class="fe fe-printer"></i>Cetak Biodata</a>
            <?php if ($penduduk['status_dasar_id'] == 1 and !empty($penduduk['id_kk'])) : ?>
              <a href="<?= site_url("keluarga/anggota/$p/$o/$penduduk[id_kk]") ?>" class="btn btn-outline-info mb-2" title="Anggota Keluarga"><i class="fe fe-users"></i> Anggota Keluarga</a>
            <?php endif; ?>
            <a href="<?= site_url("penduduk/clear") ?>" class="btn btn-outline-info mb-2" title="Kembali Ke Daftar Penduduk"> <i class="fe fe-arrow-circle-left"></i>Kembali Ke Daftar Penduduk </a>
          </div>
        </div>
        ...
        <form id="mainform" name="mainform" action="" method="post">
          <div class="row">
                  ...
                  <div class="active tab-pane" id="resume">
                    ...
                    <div class="card shadow">
                      <div class="card-header">
                        ...
                        <div class="card-tools pull-right"> <span><a class="btn btn-success btn-xs" href="<?= site_url() ?>gis/clear"><i class="fe fe-map-marker"></i> Peta Desa</a></span>
                          <button type="button" class="btn btn-card-tool" data-widget="collapse"><i class="fe fe-minus"></i> </button>
                        ...
                        <table class="table table-bordered table-striped table-hover detail">
                          ...
                          <?php foreach ($list_rumah as $key => $data) : ?>
                            <tr>
                              ...
                              <td nowrap><a href="<?= base_url() . LOKASI_RUMAH ?><?= urlencode($data['satuan']) ?>" class="btn bg-info btn-card btn-sm" rel=”noopener noreferrer” target="_blank" title="Buka Rumah"><i class="fe fe-eye"></i></a></br>
                                <?php if (!$data['hidden']) : ?>
                    ...
                    <div class="card shadow">
                      <div class="card-header">
                        ...
                        <div class="card-tools pull-right"> <span class="time"><a class="btn btn-primary btn-xs" href="<?= site_url() ?>program_bantuan"><i class="fe fe-list"></i> Daftar Program Bantuan</a></span>
                          <button type="button" class="btn btn-card-tool" data-widget="collapse"><i class="fe fe-minus"></i> </button>
                          <button type="button" class="btn btn-card-tool" data-widget="remove"><i class="fe fe-times"></i> </button>
                        </div>
                      </div>
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade" id="biodata" role="tabpanel" aria-labelledby="contact-tab">
                <div class="post">
                ...
                <tbody>
                  <?php foreach ($list_dokumen as $data) : ?>
                    <tr>
                      ...
                      <td><?= $key + 1 ?></td>
                      <td nowrap><a href="<?= base_url() . LOKASI_DOKUMEN ?><?= urlencode($data['satuan']) ?>" class="btn btn-info btn-card btn-sm" rel=”noopener noreferrer” target="_blank" title="Buka Dokumen"><i class="fe fe-eye"></i></a>
                        <?php if (!$data['hidden']) : ?>
