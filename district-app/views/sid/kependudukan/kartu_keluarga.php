				...
				<div class="row align-items-center mb-2">
					...
					<div class="col-auto">
						<div class="form-group mr-1 mb-2 ">
							<a href="<?= site_url("keluarga/cetak_kk/$id_kk") ?>" class="btn btn-outline-info" target="_blank"><i class="fe fe-printer "></i> Cetak</a>
							<a href="<?= site_url("keluarga/doc_kk/$id_kk") ?>" class="btn btn-outline-info" target="_blank"><i class="fe fe-download"></i> Unduh</a>
							<a href="<?= site_url("keluarga/anggota/$p/$o/$id_kk") ?>" class="btn btn-outline-info" title="Rincian Anggota Keluarga">Kembali Ke Daftar Anggota Keluarga</a>
							<a href="<?= site_url("keluarga") ?>" class="btn btn-outline-info" title="Kembali Ke Daftar Anggota Keluarga">Kembali Ke Daftar Keluarga</a>
						</div>
					</div>
				</div>
