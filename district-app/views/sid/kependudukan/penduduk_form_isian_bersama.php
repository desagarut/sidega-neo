...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<select class="form-control select2 required" name="pendidikan_kk_id">
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<select class="form-control select2" name="pendidikan_sedang_id">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="row">
							<div class="col-sm-12">
								<a href="<?= site_url("penduduk/ajax_penduduk_maps/$p/$o/$penduduk[id]/1") ?>" title="Lokasi <?= $penduduk['nama'] ?>" class="btn btn-outline-info btn-sm" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Lokasi Rumah"><i class='fe fe-map-marker'></i> Cari Lokasi Tempat Tinggal</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="form-group">
					...
					<input id="tgl_3" name="tanggalperkawinan" class="form-control input-sm required date" maxlength="100" type="date" placeholder="00-00-0000" value="<?= $penduduk['tanggalperkawinan'] ?>"></input>
					<!--
					<div class="input-group input-group-sm date">
			...
			<div class="col-sm-4">
				<div class="form-group">
					...
					<div class="input-group input-group-sm date">
						<div class="input-group input-group-sm date">
							<input class="form-control" id="tgl_4" type="date" name="tanggalperceraian" value="<?= $penduduk['tanggalperceraian'] ?>">
						</div>
					</div>
				</div>
			</div>
