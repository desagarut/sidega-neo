				...
				<div class="col-md-12">
					<div class="card shadow">
						<div class="card-header">
							...
							<a href="<?= site_url($this->controller) ?>" class="btn btn-social btn-flat btn-info btn-sm " title="Kembali Ke Daftar Pembagunan"><i class="fe fe-arrow-circle-left"></i> Kembali Ke Pembangunan</a>
						</div>
						<div class="box-body">
