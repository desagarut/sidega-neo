	...
	<section class="content" id="maincontent">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-shadow">
					<div class="box-header with-border">
						<!--<a href="<?= site_url("kesehatan_balita/form_pantau") ?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Form Pantau" title="Form Pantau" class="btn btn-warning btn-box btn-sm"><i class="fe fe-plus"></i>Tambah Data</a>-->
						<a href="<?= site_url("kesehatan_balita/daftar/cetak/$filter_tgl/$filter_nik") ?>" class="btn btn-social btn-box bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Cetak" target="_blank"><i class="fe fe-printer"></i> Cetak</a>
						<a href="<?= site_url("kesehatan_balita/daftar/unduh/$filter_tgl/$filter_nik") ?>" class="btn btn-social btn-box bg-navy btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Unduh" target="_blank"><i class="fe fe-download"></i> Unduh</a>
