			...
			<div class="col-md-12">
				<div class="card shadow">
					<div class="card-header">
						...
						<a href="<?= site_url("kesehatan_balita/daftar/cetak/$filter_tgl/$filter_nik") ?>" class="btn btn-social btn-boxbtn-outline-info btn-sm " title="Cetak" target="_blank"><i class="fe fe-printer"></i> Cetak</a>
						<a href="<?= site_url("kesehatan_balita/daftar/unduh/$filter_tgl/$filter_nik") ?>" class="btn bg-navy btn-sm " title="Unduh" target="_blank"><i class="fe fe-download"></i> Unduh</a>
