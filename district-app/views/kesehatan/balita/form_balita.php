			...
			<div class="col-md-10">
				<div class="card shadow">
					<div class="card-header">
						<div class="col-md-12">
							<a href="<?= site_url('kesehatan_balita') ?>" class="btn btn-primary btn-sm " title="Kembali Ke Daftar Balita"><i class="fe fe-arrow-circle-o-left"></i> Kembali Ke Daftar Balita</a>
						</div>
					</div>
					<div class="card-body">
						<div class="row">
