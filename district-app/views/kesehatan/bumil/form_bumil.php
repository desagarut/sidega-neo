			...
			<div class="col-md-10">
				<div class="card card-shadow">
					<div class="box-header with-border">
						<div class="col-md-12">
							<a href="<?= site_url('kesehatan_bumil') ?>" class="btn btn-social btn-box btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Bumil"><i class="fe fe-arrow-circle-o-left"></i> Kembali Ke Daftar Bumil</a>
						</div>
					</div>
					<div class="card-body">
						<div class="row">
