<main role="main" class="main-content">
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url('plan')?>"><i class="fe fe-dashboard"></i> Daftar Lokasi</a></li>
	...
	<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
          ...
          <?php $this->load->view('plan/nav.php')?>
            ...
            <div class="card-header">
							<a href="<?= site_url("plan")?>" class="btn btn-sm btn-outline-info mb-1" title="Tambah Artikel">
								<i class="fe fe-arrow-circle-left "></i>Kembali ke Daftar Lokasi
            	</a>
						</div>
						<div class="box-body">
