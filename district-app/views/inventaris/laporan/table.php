																...
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= site_url('inventaris_tanah'); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fe fe-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= site_url('inventaris_peralatan'); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fe fe-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= site_url('inventaris_gedung'); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fe fe-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= site_url('inventaris_jalan/'.$data->id); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fe fe-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= site_url('inventaris_asset'); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fe fe-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= site_url('inventaris_kontruksi'); ?>" title="Lihat Data" type="button" class="btn btn-default btn-sm"><i class="fe fe-eye"></i></a>
																		</div>
																	</td>
																</tr>
															</tbody>
