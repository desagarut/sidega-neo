	...
	<section class="content" id="maincontent">
		<form id="mainformexcel" name="mainformexcel" action="" method="post" class="form-horizontal">
            ...
            <div class="card-header">
							<a href="<?= site_url('inventaris_gedung/form')?>" class="btn btn-success btn-sm"  title="Tambah Data Baru">
														...
														<?php foreach ($main as $data): ?>
															...
															<?php endif; ?>
																...
																<td nowrap>
																	...
																	<a href="<?= site_url('inventaris_gedung/edit/'.$data->id); ?>" title="Edit Data"  class="btn btn-outline-info btn-sm"><i class="fe fe-edit"></i> </a>
																	<a href="#" data-href="<?= site_url("api_inventaris_gedung/delete/$data->id")?>" class="btn btn-outline-info btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash"></i></a>
																</td>
