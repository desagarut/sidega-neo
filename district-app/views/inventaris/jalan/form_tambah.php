			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="card shadow">
						...
						<a href="<?= site_url() ?>inventaris_jalan" class="btn btn-info btn-sm "><i class="fe fe-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Jalan, Irigasi Dan Jariangan</a>
						</div>
						<?php
