<main role="main" class="main-content">
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url() ?>inventaris_peralatan"><i class="fe fe-dashboard"></i>Daftar Inventaris Jalan, Irigasi dan Jaringan</a></li>
			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="card card-shadow">
						...
						<a href="<?= site_url() ?>inventaris_jalan" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fe fe-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Jalan, Irigasi Dan Jariangan</a>
						</div>
						<?php
