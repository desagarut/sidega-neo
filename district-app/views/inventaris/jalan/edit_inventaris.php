			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="card shadow">
						...
						<a href="<?= site_url() ?>inventaris_jalan" class="btn btn-info btn-sm "><i class="fe fe-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Jalan, Irigasi dan Jaringan</a>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-12">
