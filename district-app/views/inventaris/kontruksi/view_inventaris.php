<main role="main" class="main-content">
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url() ?>inventaris_peralatan"><i class="fe fe-dashboard"></i>Daftar Inventaris Kontruksi</a></li>
	...
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_kontruksi" method="post" action="<?= $form_action?>">
            ...
            <div class="box-header with-border">
						<a href="<?= site_url() ?>inventaris_kontruksi" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fe fe-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Kontruksi</a>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-12">
