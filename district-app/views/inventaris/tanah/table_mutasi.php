														...
														<?php foreach ($main as $data): ?>
															<tr>
																...
																<td nowrap>
																	...
																	<a href="<?= site_url('inventaris_tanah/edit_mutasi/'.$data->id); ?>" title="Edit Data"  class="btn btn-outline-info btn-sm"><i class="fe fe-edit"></i> </a>
																	<a href="#" data-href="<?= site_url("api_inventaris_tanah/delete_mutasi/$data->id")?>" class="btn btn-outline-info btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash"></i></a>
																</td>
