			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="card card-shadow">
						...
						<a href="<?= site_url() ?>inventaris_peralatan" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fe fe-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Peralatan</a>
						</div>
						<?php
