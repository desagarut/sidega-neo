														...
														<?php foreach ($main as $data): ?>
															<tr>
																...
																<td nowrap>
																	...
																	<?php endif; ?>
																	<a href="<?= site_url('inventaris_asset/view_mutasi/'.$data->id); ?>" title="Lihat Data" class="btn bg-info btn-box btn-sm"><i class="fe fe-eye"></i></a>
																	<a href="<?= site_url('inventaris_asset/edit_mutasi/'.$data->id); ?>" title="Edit Data"  class="btn bg-orange btn-box btn-sm"><i class="fe fe-edit"></i> </a>
																	<a href="#" data-href="<?= site_url("api_inventaris_asset/delete_mutasi/$data->id")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash-o"></i></a>
																</td>
