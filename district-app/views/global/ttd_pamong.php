...
<form action="<?= $form_action; ?>" method="post" id="validasi" target="_blank">
	...
	<div class="modal-footer">
		<button type="reset" class="btn btn-social btn-flat btn-danger btn-sm pull-left"><i class="fe fe-times"></i> Batal</button>
		<button type="submit" class="btn btn-social btn-flat btn-info btn-sm"><i class='fe fe-check'></i> <?= ucwords($aksi); ?></button>
	</div>
</form>
