...
<div class="card shadow">
	<div class="card-header">
		<?php if ($this->CI->cek_hak_akses('u')): ?>
			<a href="<?= site_url('ba_tanah_desa/form')?>" class="btn btn-social btn-flat btn-success btn-sm btn-sm " title="Tambah Data Baru"> <i class="fe fe-plus"></i>Tambah Data </a>
		<?php endif; ?>
		<a href="#" class="btn btn-social btn-flatbtn-outline-info btn-sm " title="Cetak Buku Tanah di Desa" data-remote="false" data-toggle="modal" data-href="<?= site_url('ba_tanah_desa/cetak_tanah_desa/cetak'); ?>" data-target="#cetakBox" data-aksi="Cetak" data-title="Buku Tanah di Desa"><i class="fe fe-printer "></i> Cetak</a>
		<a href="#" class="btn btn-social btn-flat bg-navy btn-sm " title="Unduh Buku Tanah di Desa" data-remote="false" data-toggle="modal" data-href="<?= site_url('ba_tanah_desa/cetak_tanah_desa/unduh'); ?>" data-target="#cetakBox" data-aksi="Unduh" data-title="Buku Tanah di Desa"><i class="fe fe-download"></i> Unduh</a>
	</div>
	<div class="box-body">
		<div class="row">
			<div class="col-sm-12">
