				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group row" id='pilihan_pemilik'>
								<label for="jenis_pemilik" class="col-sm-4 control-label">Jenis Pemilik</label>
								<div class="btn-group col-sm-8 kiri" data-toggle="buttons">
									<label class="btn btn-info btn-sm col-sm-3 form-check-label mr-2">
										<input type="radio" name="jenis_pemilik" class="form-check-input mr-2" value="1" autocomplete="off" <?php selected((empty($main) || $main->jenis_pemilik == 1), true, true) ?> onchange="pilih_pemilik(this.value);">Warga Desa
									</label>
									<label class="btn btn-info btn-sm col-sm-3 form-check-label mr-2">
										<input type="radio" name="jenis_pemilik" class="form-check-input mr-2" value="2" autocomplete="off" <?php selected(($main->jenis_pemilik == 2), true, true) ?> onchange="pilih_pemilik(this.value);">Warga Luar Desa
									</label>
								</div>
							</div>
							<div class="form-group row" id="pilihan_penduduk">
								<label class="col-sm-4 control-label">Cari Penduduk</label>
								<div class="col-sm-8">
									<select class="form-control form-control-sm select2" style="width: 100%;" id="penduduk" name="penduduk">
							...
							<div class="form-group row" id="nama_penduduk">
								<label class="col-sm-4 control-label" style="text-align:left;" for="pemilik_asal">Nama
									Perorangan / Badan Hukum</label>
								<div class="col-sm-8">
									<input class="form-control form-control-sm nama required" type="text" placeholder="Pemilik" value="<?= $main->nama_pemilik_asal ?: $main->nama ?>" name="pemilik_asal" id="pemilik_asal" />
								</div>
							</div>
							<div class="form-group row" id="nik_penduduk">
								<label class="col-sm-4 control-label" style="text-align:left;" for="nik">NIK Penduduk</label>
								<div class="col-sm-8">
									<input class="form-control form-control-sm nik required" type="text" placeholder="NIK Penduduk" value="<?= $main->nik_penduduk ?: $main->nik ?>" name="nik" id="nik" />
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-4 control-label" style="text-align:left;" for="luas_tanah">Luas
									Tanah Total</label>
								<div class="col-sm-4">
									<div class="input-group">
										<input type="number" min="0" class="form-control form-control-sm number disabled required" value="<?= $main->luas ?: 0 ?>" id="luas" name="luas" />
					...
					<div class="row">
						<div class="col-sm-12">
							<h6 class="text-title"><strong>Status Hak Tanah :</strong></h6>
							<div class="col-sm-3">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<div class="input-group">
												<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hak_milik ?: 0 ?>" id="hak_milik" name="hak_milik" />
												<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
											</div>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<div class="input-group">
												<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hak_guna_bangunan ?: 0 ?>" id="hak_guna_bangunan" name="hak_guna_bangunan" />
												<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
											</div>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<div class="input-group">
												<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hak_pakai ?: 0 ?>" id="hak_pakai" name="hak_pakai" />
												<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
											</div>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<div class="input-group">
												<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hak_guna_usaha ?: 0 ?>" id="hak_guna_usaha" name="hak_guna_usaha" />
												<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
											</div>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<div class="input-group">
												<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hak_pengelolaan ?: 0 ?>" id="hak_pengelolaan" name="hak_pengelolaan" />
												<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
											</div>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<div class="input-group">
												<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hak_milik_adat ?: 0 ?>" id="hak_milik_adat" name="hak_milik_adat" />
												<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
											</div>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<div class="input-group">
												<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->tanah_negara ?: 0 ?>" id="tanah_negara" name="tanah_negara" />
												<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
											</div>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
												<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hak_verponding ?: 0 ?>" id="hak_verponding" name="hak_verponding" />
												<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
											</div>
										</div>
									</div>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->perumahan ?: 0 ?>" id="perumahan" name="perumahan" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->perdagangan_jasa ?: 0 ?>" id="perdagangan_jasa" name="perdagangan_jasa" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->perkantoran ?: 0 ?>" id="perkantoran" name="perkantoran" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->industri ?: 0 ?>" id="industri" name="industri" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->fasilitas_umum ?: 0 ?>" id="fasilitas_umum" name="fasilitas_umum" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->sawah ?: 0 ?>" id="sawah" name="sawah" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->tegalan ?: 0 ?>" id="tegalan" name="tegalan" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>PerkebunanPerternakan
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->perkebunan ?: 0 ?>" id="perkebunan" name="perkebunan" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->peternakan_perikanan ?: 0 ?>" id="peternakan_perikanan" name="peternakan_perikanan" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hutan_belukar ?: 0 ?>" id="hutan_belukar" name="hutan_belukar" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->hutan_lebat_lindung ?: 0 ?>" id="hutan_lebat_lindung" name="hutan_lebat_lindung" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->tanah_kosong ?: 0 ?>" id="tanah_kosong" name="tanah_kosong" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="input-group">
										<input type="text" min="0" class="form-control form-control-sm number required" value="<?= $main->lain ?: 0 ?>" id="lain_lain" name="lain_lain" />
										<span class="input-group-addon input-sm " id="koefisien_dasar_bangunan-addon">&nbsp;M<sup>2</sup></span>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<textarea rows="5" class="form-control form-control-sm nomor_sk" name="mutasi" id="mutasi" placeholder="Mutasi"><?= $main->mutasi; ?></textarea>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-3 control-label" style="text-align:left;" for="keterangan">Keterangan</label>
									<div class="col-sm-8">
										<textarea rows="5" class="form-control form-control-sm nomor_sk" name="keterangan" id="keterangan" placeholder="Keterangan"><?= $main->keterangan; ?></textarea>
									</div>
								</div>
							</div>
						</div>
