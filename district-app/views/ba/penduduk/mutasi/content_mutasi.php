...
<?php if ($tgl_lengkap && $tgl_lengkap_aktif == 1): ?>
	<div class="card shadow">
		<div class="card-header">
			<a href="<?= site_url($this->controller."/ajax_cetak/$o/cetak"); ?>" class="btn btn-social btn-flatbtn-outline-info btn-sm " title="Cetak Buku Mutasi Penduduk" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Buku Mutasi Penduduk"><i class="fe fe-printer "></i> Cetak</a>
			<a href="<?= site_url($this->controller."/ajax_cetak/$o/unduh"); ?>?>" title="Unduh Buku Mutasi Penduduk" class="btn btn-social btn-flat bg-navy btn-sm " title="Unduh Buku Mutasi Penduduk" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Buku Mutasi Penduduk"><i class="fe fe-download"></i> Unduh</a>
