...
<div class="card shadow">
	<div class="card-header">
		<a href="<?= site_url("ba_penduduk_sementara/ajax_cetak/$o/cetak"); ?>" class="btn btn-social btn-flatbtn-outline-info btn-sm " title="Cetak Buku Penduduk Sementara" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Buku Penduduk Sementara"><i class="fe fe-printer "></i> Cetak</a>
		<a href="<?= site_url("ba_penduduk_sementara/ajax_cetak/$o/unduh"); ?>?>" title="Unduh Buku Penduduk Sementara" class="btn btn-social btn-flat bg-navy btn-sm " title="Unduh Buku Penduduk Sementara" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Buku Penduduk Sementara"><i class="fe fe-download"></i> Unduh</a>
					...
					<div class="col-sm-3">
						<div class="input-group input-group-sm pull-right">
							...
							<div class="input-group-btn">
								<button type="submit" class="btn btn-default" onclick="$('#'+'mainform').attr('action', '<?= site_url("ba_penduduk_sementara/filter/cari"); ?>');$('#'+'mainform').submit();"><i class="fe fe-search"></i></button>
							</div>
						</div>
					</div>
				</div>
