...
<div class="card shadow">
	<div class="card-header">
		<a href="<?= site_url($this->controller . "/ajax_cetak/$order_by/cetak"); ?>" class="btn btn-outline-info btn-sm " title="Cetak Buku Induk Penduduk" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Cetak Buku Induk Penduduk"><i class="fe fe-printer "></i> Cetak</a>
		<a href="<?= site_url($this->controller . "/ajax_cetak/$order_by/unduh"); ?>?>" title="Unduh Buku Induk Penduduk" class="btn btn-outline-info btn-sm " title="Unduh Buku Induk Penduduk" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Buku Induk Penduduk"><i class="fe fe-download"></i> Unduh</a>
