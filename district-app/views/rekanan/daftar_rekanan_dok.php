...
<main role="main" class="main-content">
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url('rekanan') ?>"><i class="fe fe-dashboard"></i> Rekanan</a></li>
													...
													<div class="box-tools">
														<div class="input-group input-group-sm pull-right">
															...
															<div class="input-group-btn">
																<button type="data_rekananmit" class="btn btn-default" onclick="$('#'+'mainform').attr('action', '<?= site_url("rekanan/search/$rekanan") ?>');$('#'+'mainform').submit();"><i class="fe fe-search"></i></button>
															</div>
														</div>
													</div>
												</div>
														...
														<table class="table table-bordered table-striped dataTable table-hover">
															<thead class="bg-gray disabled color-palette">
																<tr>
																	...
																	<th>Gambar</th>
																	<?php if ($o == 2) : ?>
																		<th><a href="<?= site_url("rekanan/dokumen_rekanan/$rekanan/$p/1") ?>">Nama Dokumen <i class='fe fe-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o == 1) : ?>
																		<th><a href="<?= site_url("rekanan/dokumen_rekanan/$rekanan/$p/2") ?>">Nama Dokumen <i class='fe fe-sort-desc fa-sm'></i></a></th>
																	<?php else : ?>
																		<th><a href="<?= site_url("rekanan/dokumen_rekanan/$rekanan/$p/1") ?>">Nama Dokumen <i class='fe fe-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<th>Deskripsi</th>
																	<th>Aksi</th>
																</tr>
															...
															<tbody>
																<?php foreach ($dokumen_rekanan as $data) : ?>
																	<tr>
																		...
																		<td nowrap>
																			<a href="<?= site_url("rekanan/urut/$data[id]/1/$data_rekanan[id]") ?>" class="btn bg-olive btn-box btn-sm" title="Pindah Posisi Ke Bawah"><i class="fe fe-arrow-down"></i></a>
																			<a href="<?= site_url("rekanan/urut/$data[id]/2/$data_rekanan[id]") ?>" class="btn bg-olive btn-box btn-sm" title="Pindah Posisi Ke Atas"><i class="fe fe-arrow-up"></i></a>
																			<br />
																			<a href="<?= site_url("rekanan/form_dokumen_rekanan/$rekanan/$data[id]") ?>" class="btn btn-warning btn-box btn-sm" title="Ubah"><i class="fe fe-edit"></i></a>
																			<?php if ($this->CI->cek_hak_akses('h')) : ?>
																				<?php if ($data['enabled'] == '2') : ?>
																					<a href="<?= site_url("rekanan/rekanan_lock/" . $data['id'] . "/$rekanan") ?>" class="btn bg-navy btn-box btn-sm" title="Aktifkan Gambar"><i class="fe fe-lock">&nbsp;</i></a>
