          ...
          <?php $this->load->view('plan/nav.php')?>
            ...
            <div class="box-header with-border">
							...
							<?php if ($this->CI->cek_hak_akses('h')): ?>
								<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("polygon/delete_all/$p/$o")?>')" class="btn btn-social btn-box btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block hapus-terpilih"><i class='fe fe-trash-o'></i> Hapus Data Terpilih</a>
							<?php endif; ?>
						</div>
						<div class="box-body">
							<div class="row">
																...
																<?php foreach ($main as $data): ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<a href="<?= site_url("polygon/sub_polygon/$data[id]")?>" class="btn bg-purple btn-box btn-sm"  title="Rincian <?= $data['nama']?>"><i class="fe fe-bars"></i></a>
																			...
																			<?php endif ?>
																			<a href="#" data-href="<?= site_url("polygon/delete/$p/$o/$data[id]")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash-o"></i></a>
																	  </td>
