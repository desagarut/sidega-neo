					...
					<?php if ($detail["status"] == 1) : ?>
						<div class="btn-group btn-group-vertical">
							...
							<ul class="dropdown-menu" role="menu">
								<li>
									<a href="<?= site_url("program_bantuan/aksi/1/" . $detail['id']) ?>" class="btn btn-block btn-sm" title="Tambah Satu Peserta Baru "><i class="fe fe-plus"></i> Tambah Satu Peserta Baru</a>
								</li>
								<li>
									<a href="<?= site_url("program_bantuan/aksi/2/" . $detail['id']) ?>" class="btn btn-block btn-sm" title="Tambah Beberapa Peserta Baru"><i class="fe fe-plus"></i> Tambah Beberapa Peserta Baru</a>
								</li>
							</ul>
						</div>
					<?php endif; ?>
