			...
			<li class="active">Daftar Program Bantuan</li>
				...
				<div class="card shadow">
					<div class="card-header">
                        ...
                        <a href="<?=site_url('program_bantuan/create')?>" class="btn btn-outline-info btn-sm" title="Tambah Program Bantuan"><i class="fe fe-plus"></i> Tambah</a>
						<a href="<?=site_url('program_bantuan/impor')?>" class="btn btn-outline-info btn-sm" title="Impor Program Bantuan" data-target="#impor" data-remote="false" data-toggle="modal" data-backdrop="false" data-keyboard="false"><i class="fe fe-upload"></i> Impor</a>
						<?php endif;?>
														...
														<?php foreach ($program as $item): ?>
															...
															<tr>
                                                                ...
                                                                <td nowrap>
																	...
																	<a href="<?= site_url("program_bantuan/edit/$item[id]")?>" class="btn btn-outline-info btn-sm" title="Ubah"><i class="fe fe-edit"></i></a>
																	...
																	<?php endif ?>
																	<?php if ($item['jml_peserta'] == 0): ?>
																		<a href="#" data-href="<?= site_url("program_bantuan/hapus/$item[id]")?>" class="btn btn-outline-info btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash"></i></a>
																	<?php endif ?>
																</td>
                                                                <?php endif;?>
