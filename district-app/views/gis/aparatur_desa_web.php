  ...
  <div class="card shadow">
    <div class="card-body">
      <div id="aparatur_desa" class="cycle-slideshow"
        ...
        <span class="cycle-prev"><img src="<?= base_url()?>assets/images/back_button.png" alt="Back"></span> <span class="cycle-next"><img src="<?= base_url()?>assets/images/next_button.png" alt="Next"></span>
