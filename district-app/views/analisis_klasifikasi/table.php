	...
	<section class="content" id="maincontent">
		<form id="mainform" name="mainform" action="" method="post">
            ...
            <div class="box-header with-border">
							...
							<a href="<?= site_url() ?>analisis_klasifikasi/leave" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fe fe-arrow-circle-left "></i> Kembali Ke <?= $analisis_master['nama']?></a>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-sm-12">
															...
															<tbody>
																<?php foreach ($main as $data): ?>
																	<tr>
																		...
																		<td><?= $data['no']?></td>
																		<td nowrap>
																			<a href="<?= site_url("analisis_klasifikasi/form/$p/$o/$data[id]") ?>" class="btn bg-orange btn-box btn-sm"  title="Ubah Data"  data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Data Kategori Indikator"><i class='fe fe-edit'></i></a>
																			<a href="#" data-href="<?= site_url("analisis_klasifikasi/delete/$p/$o/$data[id]") ?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash-o"></i></a>
																		</td>
