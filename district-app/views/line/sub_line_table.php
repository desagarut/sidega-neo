		...
		<form id="mainform" name="mainform" action="" method="post">
          ...
          <?php $this->load->view('plan/nav.php')?>
            ...
            <div class="card-header">
							<a href="<?= site_url("line/ajax_add_sub_line/$line[id]")?>" class="btn btn-success btn-sm btn-sm "  title="Tambah Kategori <?= $line['nama'] ?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tambah Kategori <?= $line['nama'] ?>">
								<i class="fe fe-plus"></i>Tambah Kategori <?= $line['nama'] ?>
            	</a>
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("line/delete_all_sub_line/")?>')" class="btn btn-danger btn-sm  hapus-terpilih"><i class='fe fe-trash-o'></i> Hapus Data Terpilih</a>
																...
																<?php foreach ($subline as $data): ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<?php endif; ?>
																			<a href="#" data-href="<?= site_url("line/delete_sub_line/$line[id]/$data[id]")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash-o"></i></a>
																	  </td>
