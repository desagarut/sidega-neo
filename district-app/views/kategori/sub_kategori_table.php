          ...
          <?php $this->load->view('kategori/menu_kiri.php')?>
            ...
            <div class="card-header">
              <a href="<?= site_url("kategori/ajax_add_sub_kategori/$kategori")?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tambah Sub Kategori"  class="btn btn-success btn-sm "><i class='fe fe-plus'></i> Tambah Sub Kategori</a>
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("kategori/delete_all_sub_kategori/$kategori")?>')" class="btn btn-outline-danger btn-sm btn-sm hapus-terpilih"><i class='fe fe-trash'></i> Hapus Data Terpilih</a>
							...
							<div class="row">
								<div class="col-sm-12">
                                  ...
                                  <th>Link</th>
                                      ...
                                      <a href="<?= site_url("kategori/ajax_add_sub_kategori/$kategori/$data[id]")?>" class="btn btn-outline-info btn-sm" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Data" title="Ubah Data"><i class="fe fe-edit"></i></a>
																			...
																			<?php endif; ?>
																			<a href="#" data-href="<?= site_url("kategori/delete_sub_kategori/$kategori/$data[id]")?>" class="btn btn-outline-info btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash"></i></a>
																	  </td>
