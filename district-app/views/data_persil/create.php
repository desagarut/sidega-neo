			...
			<div class="col-md-9">
				<div class="card shadow">
					<div class="card-header">
						<a href="<?= site_url('letterc/clear') ?>" class="btn btn-primary btn-sm " title="Kembali Ke Daftar Letter-C"><i class="fe fe-arrow-circle-o-left"></i> Kembali Ke Daftar Letter-C</a>
					</div>
