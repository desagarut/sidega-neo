				...
				<div class="card shadow">
					<div class="box-body">
						<div class="card-header">
							<a href="<?= site_url('data_persil/clear')?>" class="btn btn-primary btn-sm " title="Kembali Ke Daftar Persil"><i class="fe fe-arrow-circle-o-left"></i> Kembali Ke Daftar Persil</a>
						</div>
						<div class="row">
							<div class="col-sm-12">
