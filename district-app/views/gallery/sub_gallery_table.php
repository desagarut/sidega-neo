				...
				<div class="col-md-12">
					<div class="card shadow">
						<div class="card-header">
							<a href="<?= site_url("gallery/form_sub_gallery/$gallery") ?>" class="btn btn-success btn-sm" title="Tambah Album">
								<i class="fe fe-plus"></i> Tambah Gambar Baru
							</a>
							<?php if ($this->CI->cek_hak_akses('h')) : ?>
								<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("gallery/delete_all_sub_gallery/$gallery") ?>')" class="btn btn-outline-danger btn-sm btn-sm hapus-terpilih"><i class='fe fe-trash'></i> Hapus Data Terpilih</a>
							<?php endif; ?>
																	...
																	<tr>
																		...
																		<td nowrap>
																			...
																			<?php if ($this->CI->cek_hak_akses('h')) : ?>
																				...
																				<?php endif ?>
																				<a href="#" data-href="<?= site_url("gallery/delete_sub_gallery/$gallery/$data[id]") ?>" class="btn btn-outline-info btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fe fe-trash"></i></a>
																			<?php endif; ?>
																		</td>
																		<td class="padat">
