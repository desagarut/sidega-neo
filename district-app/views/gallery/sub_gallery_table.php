				...
				<div class="col-md-12">
					<div class="card shadow">
						<div class="card-header">
							<a href="<?= site_url("gallery/form_sub_gallery/$gallery") ?>" class="btn btn-success btn-sm btn-sm " title="Tambah Album">
								<i class="fe fe-plus"></i> Tambah Gambar Baru
							</a>
							<?php if ($this->CI->cek_hak_akses('h')) : ?>
								<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("gallery/delete_all_sub_gallery/$gallery") ?>')" class="btn btn-danger btn-sm  hapus-terpilih"><i class='fe fe-trash-o'></i> Hapus Data Terpilih</a>
							<?php endif; ?>
