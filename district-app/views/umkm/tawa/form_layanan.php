<main role="main" class="main-content">
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url('tawa')?>"><i class="fe fe-dashboard"></i> Daftar Transportasi Warga</a></li>
			<li><a href='<?= site_url("tawa/layanan/$album")?>'><i class="fe fe-dashboard"></i> Daftar Layanan</a></li>
	...
	<section class="content" id="maincontent">
		<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="card-header">
							<a href="<?= site_url("tawa/layanan/$album")?>" class="btn btn-sm btn-outline-info mb-1" title="Tambah Artikel">
								<i class="fe fe-arrow-circle-left "></i>Kembali</a>
						</div>
						<div class="box-body">
