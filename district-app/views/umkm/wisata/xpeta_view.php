...
<div class="col-sm-3">
  <div class="box box-warning">
    <div class="box-body box-profile"> <img class="img-responsive img-circle" src=<?= AmbilGaleri($sub['gambar'], 'kecil') ?>>
      ...
      </ul><a href="https://wa.me/+62<?= $sub['no_hp_pengelola'] ?>?text=Assalamu'alaikum%2C%20halo%20saya%20tertarik%20dengan%20produk%20anda%20yang%20ditawarkan%20di%20website%20desa.%20Apakah%20produknya%20masih%20tersedia%3F" class="btn bg-green btn-box btn-sm"  target="_blank" title="Hubungi"><i class="fe fe-whatsapp"></i> Hubungi</a> 
      <a href="<?= site_url("first/wisata_fasilitas/".$sub['id'])?>" target="_blank" class="btn bg-blue btn-box btn-sm"  target="_blank" title="Lihat Wisata"><i class="fe fe-whatsapp"></i> Lihat Wisata</a>
    </div>
  </div>
</div>
<div class="col-sm-9">
