<main role="main" class="main-content">
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?= site_url('toko_warga')?>"><i class="fe fe-dashboard"></i> Daftar Wisata</a></li>
			<li><a href='<?= site_url("wisata/fasilitas/$album")?>'><i class="fe fe-dashboard"></i> Daftar fasilitas</a></li>
	...
	<section class="content" id="maincontent">
		<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="card-header">
							<a href="<?= site_url("wisata/fasilitas/$album")?>" class="btn btn-sm btn-outline-info mb-1" title="Tambah Artikel">
