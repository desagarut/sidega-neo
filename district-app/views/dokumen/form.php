	...
	<div class="container-fluid">
		...
		<ol class="breadcrumb">
			...
			<?php if (in_array($kat, array('2', '3'))): ?>
				<li><a href="<?= $kembali_ke ?: site_url("$this->controller/peraturan_desa/$kat"); ?>"><i class="fe fe-dashboard"></i> Daftar <?= $kat_nama?></a></li>
			<?php else: ?>
				<li><a href="<?= site_url("$this->controller/index/$kat"); ?>"><i class="fe fe-dashboard"></i> Daftar <?= $kat_nama?></a></li>
			<?php endif; ?>
